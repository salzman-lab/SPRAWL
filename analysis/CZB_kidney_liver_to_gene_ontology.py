...
in_path = '/oak/stanford/groups/horence/rob/isoform_localizations/SRRS/outputs/gene_cell/CZB_liver_peripheral.csv'
out_path = '/oak/stanford/groups/horence/rob/isoform_localizations/SRRS/outputs/gene_ontology/CZB_liver_periph.csv'

viz_df = pd.read_csv(in_path)
viz_df = viz_df.rename(columns={'annotation':'ontology'})
viz_df['sample_id'] = 'liver'
...
viz_agg_df.to_csv(out_path ,index=False)
