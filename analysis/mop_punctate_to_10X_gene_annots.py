...
mop_df = pd.read_csv('../outputs/gene_cell/MOp_punctate.csv')
...
mop_df.to_csv('/oak/stanford/groups/horence/rob/isoform_localizations/SRRS/outputs/gene_cell/MOp_punctate_10X_ontology.csv',index=False)
...
#Write out
mop_agg_df.to_csv('/oak/stanford/groups/horence/rob/isoform_localizations/SRRS/outputs/gene_ontology/MOp_punctate_10X_ontology.csv',index=False)
