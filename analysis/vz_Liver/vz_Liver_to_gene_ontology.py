...
in_paths = glob.glob('/oak/stanford/groups/horence/rob/isoform_localizations/SRRS/outputs/gene_cell/Liver?Slice?_peripheral.csv')

for in_path in in_paths:
    print(in_path)
    f_name = os.path.basename(in_path)
    out_path = os.path.join('/oak/stanford/groups/horence/rob/isoform_localizations/SRRS/outputs/gene_ontology',f_name)
