...
mop_df = pd.read_csv('../outputs/gene_cell/MOp_shrunk_periph.csv')
...
mop_df.to_csv('/oak/stanford/groups/horence/rob/isoform_localizations/SRRS/outputs/gene_cell/MOp_shrunk_peripheral_ReadZs_gene_ontology.csv',index=False)
...
#Write out
mop_agg_df.to_csv('/oak/stanford/groups/horence/rob/isoform_localizations/SRRS/outputs/gene_ontology/MOp_shrunk_peripheral_ReadZs_gene_ontology.csv',index=False)
