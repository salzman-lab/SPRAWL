...
mop_df['ontology'] = mop_df['annotation'].map(mop_ann_to_ss2_map)
...
#Write out
mop_agg_df.to_csv('/oak/stanford/groups/horence/rob/isoform_localizations/SRRS/outputs/gene_ontology/MOp_periphal_ReadZs_SS2_gene_ontology.csv',index=False)
