...
file_stem = '/scratch/groups/horence/Elisabeth/intron_zscore/Rob_data/results/medians/*.txt'
out_path = '/oak/stanford/groups/horence/rob/isoform_localizations/SRRS/outputs/readzs/UTR_level/Liver_kidney_10Xv3_no_unann_filt.csv'
bed_path = '/oak/stanford/groups/horence/rob/isoform_localizations/SRRS/inputs/kidney_liver_genes.bed'

fps = glob.glob(file_stem)
fps = [fp for fp in fps if 'signif' not in fp]
...
df = df.rename(columns={'pval':'perm_p_val'})
